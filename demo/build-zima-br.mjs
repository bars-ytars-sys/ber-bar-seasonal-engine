...
const пункты = [
  ...
  ['стол', 'Ресторан на базе', 'Праздничный стол можно не готовить: ресторан рядом, блюда привезут в дом.']
];
...
<meta name="description" content="Новогодние праздники на экобазе «Берёзовая роща» в Подмосковье: 22 дизайнерских домика с банными чанами, SPA-комплекс с бассейном под открытым небом, ресторан и ферма с животными — 40 минут от Москвы.">
<style>${СТИЛИ}</style>
</head>
<body>
...
<section class="герой">
  ...
  <div class="герой__текст полоса">
    ...
    <p class="лид">Дизайнерские домики с чаном, SPA-комплекс, ресторан и ферма — 40 минут от Москвы</p>
    <div class="кнопки">
...
<section class="раздел полоса" id="описание">
  <div class="описание">
    ...
    <div class="описание__текст">
      ...
      <h2>Праздник, который не нужно организовывать</h2>
      <p class="вводный">40 минут от Москвы — и всё уже есть: тёплый дизайнерский дом, банный чан у крыльца,
        SPA с бассейном под открытым небом, ресторан и ферма. Никакой суеты, только праздник в своём темпе.</p>
...
<section class="раздел полоса" id="заезд">
  ...
  <div class="заезд">
    <div class="заезд__кратко">
      ...
      <p class="заезд__лид">Дизайнерский дом с банным чаном, ресторан и SPA-комплекс рядом:
