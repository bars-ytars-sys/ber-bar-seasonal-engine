  ...
  <div class="описание">
    ...
    <div class="описание__текст">
      ...
      <p class="вводный">Около часа от Москвы — и вы в берёзовом лесу: в доме тепло, у крыльца парит банный чан,
        а рядом — SPA с бассейном под открытым небом. Никакой суеты, только праздник в своём темпе.</p>
...
<section class="раздел полоса" id="заезд">
  ...
  <div class="заезд">
    <div class="заезд__кратко">
      ...
      <p class="заезд__лид">Дом в зимнем лесу, банный чан прямо у дома и SPA-комплекс рядом:
