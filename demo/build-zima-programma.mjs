...
const разделы = [
  ...
  ['fotozony', 'Фотозоны и костюмы', Ф('tild3636-3566-4263-a665-393639366466', '4H3A0913.jpg'),
   ['Окунитесь в атмосферу русского праздника: примеряйте костюмы Деда Мороза, Снегурочки и народные наряды.',
    'Костюмы выдаём бесплатно. Памятные снимки можно сделать у баннера-тантамарески и в праздничных декорациях на территории.']],
  ['podarki', 'Подарки для всех', Ф('tild3736-3363-4133-b537-363264303466', 'noroot.png'),
   ['В каждом домике гостей ждут праздничные сувениры для взрослых и детей.',
...
const условия = [
  ...
  ['Заезд и выезд', 'Заезд с 16:00, выезд до 13:00. Ранний заезд и поздний выезд возможны по согласованию, при наличии мест, оплачиваются отдельно.'],
  ...
  ['С питомцем', 'Можно, комфортнее всего в домах Гарден и в Барском доме. За весь период до 5 кг 1000 ₽, более 5 кг 2000 ₽. Дадим миску, а для крупных питомцев лежанку.'],
...
<section class="полоса" id="zayavka">
  <div class="заявка">
    ...
    <p>Расскажите, сколько вас и что важно, и мы подберём дом и посчитаем стоимость.</p>
    <div class="действия" style="text-align:left;margin-top:6px">
      ...
      <a class="действие" href="${БРОНЬ}"><b>Выбрать даты</b><span>свободные дома с 30.12 по 10.01</span></a>
    </div>
  </div>
</section>
