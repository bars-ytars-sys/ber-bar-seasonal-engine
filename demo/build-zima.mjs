...
const дома = [
  ['Ривер и Гарден', '4 спальных места · 55 м² · два этажа',
   'Своя территория и банный чан у дома. Ривер стоит у реки, с живой изгородью. Гарден в лесу и огорожен полностью, у некоторых домов своя баня.',
...
<section class="раздел полоса" id="заезд">
  ...
  <div class="заезд">
    <div class="заезд__кратко">
      ...
      <div class="заезд__даты">с 31 декабря по 10 января</div>
