...
const пункты = [
  ...
  ['чан', 'Банный чан у каждого дома', 'Под открытым небом.'],
  ['огонь', 'Баня и сауна', 'Сауна есть в Барском доме. Баня есть в Шале и у некоторых домов Ривер и Гарден.'],
  ['кролик', 'Свои животные', 'Кролики, шиншиллы, козочки и павлины. Бесплатно и без ограничений.'],
  ['мишка', 'Детская игровая «Детский мир»', 'Дети играют, а вы спокойно отдыхаете.'],
...
const программа = [
  ['Беспроигрышная лотерея', Ф('tild6135-3933-4964-b961-373634613538', 'ukrasennaa-elka-s-po.jpg'),
   'Каждый гость при заезде может выиграть приятные подарки и сюрпризы!'],
  ['Фотозоны и костюмы', Ф('tild3636-3566-4263-a665-393639366466', '4H3A0913.jpg'),
   'Окунитесь в атмосферу русского праздника: примеряйте костюмы Деда Мороза, Снегурочки и народные наряды. Памятные снимки можно сделать у баннера-фотозоны и в стильных декорациях!'],
  ['Подарки для всех', Ф('tild3736-3363-4133-b537-363264303466', 'noroot.png'),
   'В каждом домике вас ждут праздничные сувениры для взрослых и детей.'],
...
const ЯКОРЯ = ['loterea', 'fotozony', 'podarki', 'razvlecheniya', 'ded-moroz'];

const вопросы = [
  ['Во сколько заезд и выезд?',
   'Заезд с 16:00, выезд до 13:00. Ранний заезд или поздний выезд возможен по согласованию с администрацией, при наличии свободных мест, оплачивается отдельно.'],
  ['Сколько стоит новогодний отдых?',
   'Стоимость зависит от дома и дат: дома разного размера и вместимости. Напишите или позвоните, и менеджер посчитает стоимость под вашу компанию.'],
  ...
  ['Можно ли приехать с питомцем?',
   'Да. Комфортнее всего с питомцами в домах Гарден и в Барском доме. За весь период пребывания: до 5 кг 1 000 ₽, более 5 кг 2 000 ₽. Дадим миску, а для крупных питомцев лежанку.'],
...
.заезд__даты{display:inline-block;margin:0 8px 8px 0;padding:8px 16px;border-radius:999px;color:#ffd9b8;font-size:14px;
...
<section class="герой">
  ...
  <div class="герой__текст полоса">
    ...
    <h1>Зимняя сказка</h1>
    <p class="подзаголовок">Новогодние заезды с 30 декабря по 2 января и с 31 декабря по 3 января</p>
    <p class="ночи">Зимний лес в часе от Москвы, наряженный дом, банный чан и праздник в своём темпе</p>
    <div class="кнопки">
...
<section class="полоса отсчёт-полоса">
  <div class="отсчёт">
    <div class="отсчёт__заг">До Нового года осталось</div>
...
<section class="раздел полоса" id="заезд">
  ...
  <div class="заезд">
    <div class="заезд__кратко">
      <div class="заезд__даты">с 30 декабря по 2 января</div>
      <div class="заезд__даты">с 31 декабря по 3 января</div>
      <p class="заезд__лид">Дом уже украшен, чан топится к вашему приезду, а вокруг идёт праздничная программа:
        лотерея при заезде, 31 декабря Дед Мороз и снежные забавы.</p>
      <ul class="заезд__список">
        <li>${иконка('ёлка')}Украшенный дом</li>
      ...
      <div class="подробно__сетка">
        <div>
          ...
          <ul>
            ...
            <li>бесплатные русские народные костюмы для фото</li>
          </ul>
        </div>
        <div>
...
<section class="полоса" id="заявка">
  <div class="заявка">
    ...
    <p>Расскажите, сколько вас и что важно, и мы посчитаем стоимость и подберём дом под компанию.</p>
    <a class="кнопка" href="${БРОНЬ}">Забронировать новогодний отдых</a>
...
<footer class="подвал" id="контакты">
  <div class="полоса подвал__сетка">
    <div class="подвал__карта">
      <h3>Как добраться</h3>
      <iframe src="https://yandex.ru/map-widget/v1/org/barskiye_polya/218830724182/?ll=36.595236%2C56.333142&z=14" loading="lazy" title="Барские поля на Яндекс Картах" allowfullscreen></iframe>
      <p class="подвал__адрес">Московская область, Новорижское шоссе, деревня Степаньково · около часа от Москвы</p>
      <div class="подвал__ссылки"><a href="https://yandex.ru/maps/org/barskiye_polya/218830724182/" target="_blank" rel="noopener">Открыть в Яндекс Картах</a><a href="https://go.2gis.com/5Y9FT" target="_blank" rel="noopener">2ГИС</a></div>
    </div>
    <form class="подвал__форма" id="форма-заявки" novalidate data-база="Барские поля" data-чат="https://t.me/bazabarskie_polya" data-тел="+7 (495) 150-39-08" data-tel-link="tel:+74951503908">
      ...
      <p class="подвал__согласие">Нажимая кнопку, вы соглашаетесь с <a href="https://barskie-polya.ru/privacy" target="_blank" rel="noopener">политикой конфиденциальности</a>.</p>
      <p class="подвал__итог" role="status" hidden></p>
    </form>
    <div class="подвал__контакты">
      <h3>Контакты</h3>
      <a class="подвал__тел" href="tel:+74951503908">+7 (495) 150-39-08</a>
      <p>Отдел бронирования работает с 9:00 до 24:00</p>
      <div class="подвал__мессенджеры"><a href="https://t.me/bazabarskie_polya" target="_blank" rel="noopener">Telegram</a><a href="https://wa.me/message/MGCS5YIC6FBCL1" target="_blank" rel="noopener">WhatsApp</a><a href="https://vk.ru/barskiepolya" target="_blank" rel="noopener">ВКонтакте</a></div>
      <a class="кнопка кнопка--контур" href="${БРОНЬ}">Забронировать онлайн</a>
    </div>
  </div>
  <div class="полоса подвал__низ">База отдыха «Барские поля» · Московская область, Новорижское шоссе, деревня Степаньково · около часа от Москвы</div>
</footer>
