...
const пункты = [
  ...
  ['стол', 'Ресторан', 'Новогодний банкет в ресторане (оплачивается отдельно)']
];

/* Дома — по группам, данные и зимние фото со страниц домов ecobr.ru. */
const дома = [
  ['A-фреймы', 'до 4 гостей',
   'Треугольные дома с панорамным остеклением: белый, чёрный, люкс и нео. У каждого банный чан, у чёрного есть своя баня.',
   'demo/assets/eco-ng-aframe.webp'],
  ['Хаусы', 'до 5 гостей',
   'Двухэтажные дома с изолированной спальней и банным чаном. Подойдут для семьи или компании друзей.',
...
const включено = [
  ['огонь', 'SPA-комплекс в 300 метрах', 'Горячий бассейн под открытым небом, турецкий хамам, русская баня на дровах и массаж. Оплачивается отдельно.'],
...
const вопросы = [
  ...
  ['Сколько стоит новогодний отдых?', 'Цена зависит от выбранного дома и количества человек. Менеджер посчитает под вашу компанию.'],
  ['Входит ли банный чан?', 'Чан оплачивается отдельно: 5 500 ₽ классический, 7 000 ₽ в SPA House. Топим к вашему приезду.'],
  ['Что с питанием?', 'В каждом доме кухня со всем необходимым: посуда и техника. Новогодний банкет в ресторане оплачивается отдельно.'],
...
<section class="герой">
  ...
  <div class="герой__текст полоса">
    ...
    <p class="лид">Дизайнерские домики с чаном, SPA-комплекс и ферма в 40 минутах от Москвы</p>
    <div class="кнопки">
      <a class="кнопка" href="${БРОНЬ}">Забронировать дом</a>
      <a class="кнопка кнопка--контур" href="#заезд">Подробнее</a>
    </div>
  </div>
</section>
...
<section class="раздел полоса" id="описание">
  <div class="описание">
    <div class="описание__фото">
      ...
      <div class="значок"><b>с 31 декабря по 10 января</b><span>новогодние праздники</span></div>
    </div>
    <div class="описание__текст">
      ...
      <div class="условия">
        ...
        <div class="условие">${иконка('дом')}<div><b>Цена по запросу</b><span>зависит от дома и количества человек</span></div></div>
...
<section class="полоса" id="заявка">
  <div class="заявка">
    ...
    <p>Расскажите, сколько вас и что важно, и мы посчитаем стоимость и предложим свободные дома на праздники.</p>
    <div class="кнопки">
      <a class="кнопка" href="${БРОНЬ}">Забронировать новогодний отдых</a>
      <a class="кнопка кнопка--контур" href="${ТГ}">Написать менеджеру</a>
    </div>
